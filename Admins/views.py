...
def get_doctor_details(request,id):
    ...
    subscribe_res = requests.post("https://drishtis.app/drishti_masters/api/subscription_history/", json={"doctor_id":id})
...
def reset_doctorpassword(request):
    ...
    if request.method == 'POST':
        try:
            ...
            api_response = requests.post('https://drishtis.app/drishti_medicalrecord/api/reset_doctor_password/', json={
                'doctor_id': doctor_id,
...
def extend_trial(request):
    ...
    sub_url="https://drishtis.app/drishti_masters/api/extend_doctor_subscription/"
    api_data={
                "doctor_id": doctor_id,
...
def allcrmuser(request):
    if(request.user.is_authenticated):
        api_url_users = "https://drishtis.app/drishti_masters/api/get_all_Authusers/"
        allusers = []
...
def get_crmuser_details(request,id):
    print(id)
    res = requests.post('https://drishtis.app/drishti_masters/api/get_crmuser_details/',json={'lead_by_id':id})
    if(res.json().get('message_code')==1000):
        data = res.json().get('message_data')
        print(data)
    else:
...
def allpharmacist(request):
    if(request.user.is_authenticated):
        res=requests.get('https://drishtis.app/drishti_medicalrecord/api/allPharmacist/')
        print(res.text)
        if(res.json().get('message_code')==1000):
...
def get_pharmacy_details(request,id):
    print(id)
    pharmacy_res = requests.post('https://drishtis.app/drishti_medicalrecord/api/get_pharmacist_by_id/',json={'pharmacist_id':id})
    ...
    stats_res = requests.post('https://drishtis.app/drishti_medicalrecord/api/get_pharmacist_stats/',json={'pharmacist_id':id})
    ...
    doctor_res = requests.post('https://drishtis.app/drishti_medicalrecord/api/get_pharmacist_doctor_bypharmacistid/',json={'pharmacist_id':id})
...
def reset_pharmacistpassword(request):
    ...
    if request.method == 'POST':
        try:
            ...
            #Call the external API to reset the password
            api_response = requests.post('https://drishtis.app/drishti_medicalrecord/api/reset_pharmacist_password/', json={
...
def filter_pharamcist(request):
    if request.method == 'GET':
        ...
        print(end_date,'end_date')
        data=[]
        res=requests.post("https://drishtis.app/drishti_medicalrecord/api/fillter_pharmacists/",json={"doctor_name": doctor_name,"start_date":start_date,"end_date":end_date})
        print(res.text)
        data=res.json().get('message_data',[])
        print(data)
...
def allLaboratory(request):
    if(request.user.is_authenticated):
        res=requests.get('https://drishtis.app/drishti_medicalrecord/api/allLaboratory/')
        print(res.text)
        if(res.json().get('message_code')==1000):
...
def get_laboratory_details(request,id):
    print(id)
    laboratory_res = requests.post('https://drishtis.app/drishti_medicalrecord/api/get_laboratory_by_id/',json={'laboratory_id':id})
    ...
    stats_res = requests.post('https://drishtis.app/drishti_medicalrecord/api/get_laboratory_stats/',json={'laboratory_id':id})
    #print(stats_res.text)
    ...
    doctor_res = requests.post('https://drishtis.app/drishti_medicalrecord/api/get_laboratory_doctor_bylaboratoryid/',json={'laboratory_id':id})
    print(doctor_res.text)
...
def reset_laboratorypassword(request):
    ...
    if request.method == 'POST':
        try:
            ...
            #Call the external API to reset the password
            api_response = requests.post('https://drishtis.app/drishti_medicalrecord/api/reset_laboratory_password/', json={
...
def filter_laboratory(request):
    if request.method == 'GET':
        ...
        print(end_date,'end_date')
        data=[]
        res=requests.post("https://drishtis.app/drishti_medicalrecord/api/fillter_laboratories/",json={"doctor_name": doctor_name,"start_date":start_date,"end_date":end_date})
        data=res.json().get('message_data',[])
        print(data)
...
def AddDeals(request):
    if(request.user.is_authenticated):
        if(request.method=='GET'):
            category_res = requests.post('https://drishtis.app/drishti_masters/api/get_deal_categories/')
            ...
            deal_res = requests.post('https://drishtis.app/drishti_masters/api/insert_deal_and_publish_details/',json={'deal':deal_data,'publish':publish_data})
            print(deal_res.text)
            if(deal_res.json().get('message_code')==1000):
                ...
                category_res = requests.post('https://drishtis.app/drishti_masters/api/insert_deal_category_links/',json={"deal_id":response_data.get('deal_id'),"publish_id":response_data.get('publish_id'),"deal_category_ids":deal_category_ids})
                print(category_res.text)
...
def ShowAllDeals(request):
    if(request.user.is_authenticated):
        res = requests.get('https://drishtis.app/drishti_masters/api/get_active_deals/')
        print(res.text)
        if(res.json().get('message_code')==1000):
...
def get_deal_details(request,id):
    if(request.user.is_authenticated):
        print(id)
        res = requests.post('https://drishtis.app/drishti_masters/api/get_deal_details_by_deal_id/',json={ "deal_id":id})
        print(res.text)
        if(res.json().get('message_code')==1000):
...
def update_deal(request):
    if request.method == 'POST':
        try:
            ...
            update_res = requests.post('https://drishtis.app/drishti_masters/api/update_deal/',json=deal_data)
            print(update_res.text)
            # Return success response
            category_res = requests.post('https://drishtis.app/drishti_masters/api/insert_deal_category_links/',json={"deal_id":request.POST.get('Deal_id'),"publish_id":request.POST.get('Publish_id'),"deal_category_ids":deal_category_ids})
            print(category_res.text)
...
def republish_deal(request):
    if request.method == 'POST':
        ...
        res = requests.post('https://drishtis.app/drishti_masters/api/insert_publish_details/',json={'publish':publish_data})
        print(res.text)
        return JsonResponse({
            'success': True,
...
def filter_deal(request):
    if request.method == 'GET':
        ...
        #print(end_date,'end_date')
        data=[]
        res=requests.post("https://drishtis.app/drishti_masters/api/filter_deals/",json={"companyname": company_name,"status":status,"visibleoptions":visible_options_str})
        print(res.text)
        data=res.json().get('message_data',[])
        print(data)
